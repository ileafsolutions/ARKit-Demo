...
class FocusSquare: SCNNode {
    ...
    static let primaryColor =  UIColor.red //#colorLiteral(red: 1, green: 0.8, blue: 0, alpha: 1) // base yellow
	static let primaryColorLight = UIColor.red// #colorLiteral(red: 1, green: 0.9254901961, blue: 0.4117647059, alpha: 1) // light yellow
...
//            let saturation = 2.8 * (elapsedTimePercentage - 0.5) * (elapsedTimePercentage - 0.5) + 0.3
			if let material = node.geometry?.firstMaterial {
				material.diffuse.contents = UIColor.red//UIColor(hue: 0.1333, saturation: saturation, brightness: 1.0, alpha: 1.0)
			}
		}
		return action
	}
